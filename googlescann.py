...
Original file is located at
    https://colab.research.google.com/drive/1udoiVSGK2tMtPMkSaButQU_V_tJ-rrBA
"""
...
# in below parameter 10 is the neighbours to return
# here simalrity matrix is dot product
...
# score_ah ( assymetric hashing ) it set up scoring configuration using assymetric hashing and anisotropic quantization
#
